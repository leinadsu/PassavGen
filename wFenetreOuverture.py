...
class FenetreOuverture(Tk):  # Declaration de l'objet
    ...
    def createWidgets(self):
        ...
        # ELEMENT GRAPHIQUE : Bouton dans la fenetre
        self.ouvreFenetreLogin = Button(self, text="Commencer", relief=GROOVE, font=("Calibri", 10),
                                        command=self.commandeOuvreFenetreLogin)
